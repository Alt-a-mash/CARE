<?php include('header.php');?>
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
								<div class="slider-text-inner">
									<h1>ONE PLACE...<BR> TO MEET ALL YOUR MEDIACAL NEEDS</h1>
								</div>
							</div>
						</div>
					</div>
	...
	<div id="colorlib-doctor">
		<div class="container">
			...
			<div class="row">
				<?php
				$que1 = "SELECT * FROM Doctors_Table Do JOIN Specialty_Table Sp ON Do.Specialty = Sp.Specialty_Id LIMIT 4";
				...
				while($data1 = mysqli_fetch_assoc($sel1)){
					...
					<div class='desc'>
					<h3><a href='#'>" . $data1['Doctors_Name'] . "</a></h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h2 class="line-block">Want to Search for another Doctor</h2>
					<p class="line-block"><a href="doctors.php" class="btn btn-primary btn-outline btn-cta"> See All Doctors </a></p>
				</div>
			</div>
		</div>
	</div>
