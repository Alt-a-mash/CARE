...
<body class="sec">
  ...
  <div class="container">
    <h2>News Form</h2>
    <form method="POST" action="../php/Update.php?Id=<?php echo $Id;?>&tab=News" enctype="multipart/form-data">
      <div class="row100">
        <div class="col">
          <div class="inputBox textarea">
            <input value="<?php echo $result['Medical_News'];?>" required="required" name="Ntxt1">
      ...
      <div class="row100">
        <div class="col">
          <div class="inputBox">
            <input type="date" name="Ntxt2" required="required" value="<?php echo $result['News_Date'];?>">
