  ...
  <div class="container">
    ...
    <form method="POST" action="../php/Insert.php">
      <div class="row100">
        <div class="col">
          <div class="inputBox">
            <input pattern="^[A-Za-z]+\s?[A-Za-z]+" type="text" name="Ditxt1" required="required">
        ...
        <div class="col">
          <div class="inputBox">
            <input pattern="^[A-Za-z]+\s?[A-Za-z]+" type="text" name="Ditxt2" required="required">
      ...
      <div class="row100">
        <div class="col">
          <div class="inputBox textarea">
            <textarea  required="required" name="Ditxt3"></textarea>
        ...
        <div class="col">
          <div class="inputBox textarea">
            <textarea required="required" name="Ditxt4"></textarea>
      ...
      <div class="row100">
        <div class="col">
          <div class="inputBox">
            <input pattern="^[A-Za-z]+\s?[A-Za-z]+" type="text" name="Ditxt5" required="required">
